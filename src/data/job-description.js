export const jobs = [
    {
      ...
      location: 'Centum Campus, Dongseo University, 9F, Centum jungang-ro 55, Haeundae-gu, Busan, 48058, Republic of Korea'
    ...
    },
    {
      ...
      requirements_desc: [
        '1+ years of work experience as web front-end developer',
      ...
      preferred_desc: [
        ...
        'Can run unit/UI test and debugging procedures',
    ...
    },
    {
      ...
      mission: [
        ...
        'Contribute to Opensource Quantum Software',
        'Develop various service backends'
      ],
      requirements_desc: [
        '3+ years of work experience in developing software',
        'Experience in a number of projects based on Python',
        'Willing and passionate to self-growing'
      ],
      preferred_desc: [
        'Experience using C',
